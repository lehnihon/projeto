...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // index
        if (0 === strpos($pathinfo, '/teste') && preg_match('#^/teste/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
        ...
        if ($pathinfo === '/register') {
            return array (  '_controller' => 'Teste\\TesteBundle\\Controller\\RegisterController::registerAction',  '_route' => 'user_register',);
        }
